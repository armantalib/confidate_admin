        ...
        <main className='min-h-screen lg:container py-4 px-4 mx-auto'>
            ...
            <div className="displaygrid_1 bg_white rounded-4 shadow-sm px-4 py-5 mb-3 h-auto w-full">
                ...
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Total Dates</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
                ...
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Total Test Results</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
                        <h5 className="plusJakara_semibold text_dark">{categories?.totalTest || 0}</h5>
                    </div>
                </div>
                ...
                <div className="flex gap-2 justify-start w-full">
                    <div style={{ backgroundColor: '#FFEBEF' }} className="rounded-4 w-auto p-3 h-auto flex items-center justify-center">
                        <img src={ready} className='w-3 h-auto' alt="" />
                    </div>
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Total Contacts</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
                        <h5 className="plusJakara_semibold text_dark">{categories?.totalContacts || 0}</h5>
                    </div>
                </div>
            </div>
