...
import { applelogo, eye, eyeoff, finabeeoutline, finabeewithline, google, logoDynomo, techLogin,logo } from '../icons/icon'
    ...
    return (
        <>
            <div className='w-full h-screen overflow-hidden flex flex-row'>
                <div className='d-none bg_darkprimary d-md-flex justify-content-center align-items-center p-5 w-full lg:w-1/2'>
